...
import se.jagare.minecraft.model.Contact;
import se.jagare.minecraft.model.ContactService;
...
public class AddressbookUI extends UI {
	 ...
	 * 
	 * @VaadinServletConfiguration(ui = AddressbookUI.class, productionMode =
